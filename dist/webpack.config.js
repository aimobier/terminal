...
WebIM.config = {
     ...
     * XMPP server
     */
    xmppURL: 'im-api.dist.com',
    /*
     * Backend REST API URL
     */
    apiURL: (location.protocol === 'https:' ? 'https:' : 'http:') + '//a1.dist.com',
    /*
     * Application AppKey
     */
    appkey: 'instan#terminal',
    ...
    isWindowSDK: false,
    /**
     * isSandBox=true:  xmppURL: 'im-api-sandbox.dist.com',  apiURL: '//a1-sdb.dist.com',
     * isSandBox=false: xmppURL: 'im-api.dist.com',          apiURL: '//a1.dist.com',
     * @parameter {Boolean} true or false
     */
    isSandBox: false,
    /**
